...
def create_tracer_provider(service_name: str) -> TracerProvider:
    ...
    tracer_provider.add_span_processor(
        BatchSpanProcessor(OTLPSpanExporter(endpoint=settings.TEMPO_ENDPOINT))
    )
...
def setup_tracing(
    ...
    broker=None,
    service_name: str = "faststream",
    app: Optional[FastAPI] = None,
):
    if settings.ENV != "test":
        tracer_provider = tracer_provider or create_tracer_provider(
